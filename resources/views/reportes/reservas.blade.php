        ...
        <div class="card-body">
            ...
            <div class="row mt-4 mb-4">
                ...
                <div id="imprimir" class="col-12 col-md-6 gap-2" style="display: none;">
                    <form action="{{url('imprimir/reserva')}}" class="d-flex justify-content-end" method="POST" id="form">
                        @csrf
            ...
            .then(data => {
                ...
                data.forEach((reserva, index) => {
                    ...
                    <tr>
                        ...
                        <td>${new Date(reserva.fecha).getFullYear()}</td>
                        <td>${meses[new Date(reserva.fecha).getMonth()]}</td>
                    </tr>
                    `;
                    importeTotal += parseInt(reserva.importe);
                });
                tbody.innerHTML = html;
                let formatter = new Intl.NumberFormat('es-PE', options);
                importeTotal = formatter.format(importeTotal);
                importe.innerHTML = `Importe Total: ${importeTotal}`;
