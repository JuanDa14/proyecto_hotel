                ...
                <form action="{{ route('productos.store') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-12 form-group">
                            ...
                            <input required type="text" class="form-control" id="nombre" placeholder="Ingrese la nombre" name="nombre">
                        </div>
                        {{-- <div class="col-12 form-group">
                        ...
                        <div class="col-12 form-group">
                            ...
                            <input required type="text" class="form-control" id="precio" placeholder="Ingrese la precio" name="precio">
                        </div>
