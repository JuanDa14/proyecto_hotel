                    ...
                    @can('create.insumo')
                        <div class="col-12 col-md-6 text-md-right">
                            <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                data-bs-target="#agregarproducto"><i class="fas fa-plus-circle"></i> Agregar Insumo</button>
                        </div>
                    @endcan
                </div>
            </div>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <form action="{{ route('insumos.destroy', $item->id) }}" method="post"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('insumos.store') }}" method="post">
                        @csrf
                        <div class="mb-3">
                            <label for="nombre" class="col-form-label">Nombre del Insumo:</label>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/insumos" method="post" id="editform">
                        @method('put')
                        @csrf
                        <div class="mb-3">
                            <label for="nombre" class="col-form-label">Nombre del Insumo:</label>
