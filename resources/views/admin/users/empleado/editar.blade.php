                   ...
                   <div class="row">
                       <div class="col-12 col-md-4">
                        ...
                        <label for="name">Nombre del empleado</label>
                            <input id="name" class="form-control" type="text" name="name" value="{{$empleado->nombre}}" required
                                autofocus autocomplete="name" placeholder="Nombres del empleado">
                        </div>
                       </div>
                       <div class="col-12 col-md-4">
                        <div class="form-group">
                        <label for="idapellidos">Apellidos del empleado</label>
                   ...
                   <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" aria-label="Default select example" name="txtdepartamento"
                                ...
                                @foreach ($departamentos as $item)
                                    @if ($item->id === $empleado->iddepartamento)
                                    <option selected value="{{$item->id}}">{{$item->departamento}}</option> 
                                    @else                                    
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-group">
                            ...
                            <input id="iddireccion" type="text" class="form-control" name="txtdireccion"
                                placeholder="Dirección" value="{{$empleado->direccion}}">
                        </div>
                    </div>
                   </div> 
                   <div class="row">
                    <div class="col-12 col-md-4">
                     <div class="form-group">
                         ...
                         <x-jet-input id="email" class="form-control" type="email" name="email"
                             required placeholder="Correo electrónico" value="{{$usuario->email}}"/>
                     </div>
                    </div>
                    <div class="col-12 col-md-4">
                     <div class="form-group">
                         ...
                         <x-jet-input id="password" class="form-control" type="password" name="password" required
                             autocomplete="new-password" placeholder="Contraseña" value="{{$usuario->password}}" />
                     </div>
                    </div>
                    <div class="col-12 col-md-4">
                     <div class="form-group">
                         ...
                         <x-jet-input id="password_confirmation" class="form-control" type="password"
                             ...
                             placeholder="Confirmar Contraseña" value="{{$usuario->password}}" />
                     </div>
                    </div>                     
                </div>                    
